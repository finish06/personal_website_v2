				...
				<Row>
					<Col className="align-self-center order-lg-1 order-xl-3 py-3" lg={{ span: 6 }} xl={{ span: 3 }}>
						<Row>
							<Col>
								<div align="center">
									<Image src={professionalPhoto} thumbnail className="img-photo" />
								</div>
							</Col>
						</Row>
					</Col>
					<Col className="order-xl-1 order-lg-3 order-md-2 py-3" lg={{ span: 12 }} xl={{ span: 5 }}>
						...
						<Row>
							<Col>
								<Row>
									...
									<Col>
										<h4 align="right">June 2021 - Present</h4>
									</Col>
								</Row>
							</Col>
						</Row>
						...
						<Row>
							<Col>
								<Row>
									...
									<Col>
										<h4 align="right">September 2019 - June 2021</h4>
									</Col>
								</Row>
							</Col>
						</Row>
						<Row>
							<Col>
								<p className="pro-location">DrFirst, Tulsa, OK</p>
								<ul>
									<li>Execute product roadmap</li>
									<li>Collaborate with outside stakeholders</li>
									<li>Collaborate with design, development and QA</li>
								</ul>
							</Col>
						</Row>
						<Row>
						...
						<Row>
							<Col>
								...
								<ul>
									...
									<li>
										Coordinate with pharmacy staff to create and maintian pharmacy information
										solutions
									</li>
						...
						<Row>
							<Col>
								<Row>
									...
									<Col>
										<h4 align="right">December 2014 - April 2021</h4>
									</Col>
								</Row>
							</Col>
						</Row>
